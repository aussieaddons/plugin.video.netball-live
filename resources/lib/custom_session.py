...
class Session(requests.Session):
    ...
    def request(self, method, url, *args, **kwargs):
        ...
        try:
            ...
            raise NetballLiveException('SSL Error: {0}. This is usually due '
                                       'to an old version of Kodi. Please '
                                       'upgrade to at least Kodi v17 or later.'
                                       ''.format(e))
        except Exception as e:
            raise NetballLiveException('Error: {0}'.format(e))
